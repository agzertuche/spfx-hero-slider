  ...
  private mockSlides(): Slide[] {
    return [
      ...
      },
      {
        ...
        description:
          'Cillum minim commasdodo nostrud do eiusmod aute. Pariatur adipisicing et ullamco minim dolore consequat ipsum dolore officia mollit commodo nostrud. Anim incididunt cillum id cillum consequat ullamco sunt reprehenderit.',
        categories: 'News',
